...
int main(int argc, const char *argv[]) {
  ...
  unsigned int swpCnd[3] = {20*Volume,0,100*LATLEN}; //Based on distributions
  ...
  //Initialize spin lattice randomly, the last index:if 0 spin,if 1 in cluster flag
	...
	unsigned int sumClSize; // Sum of all cluster sizes obtained within the sweep
	...
	bool measFlag;
	unsigned int NSKIP = 10+Volume/swpCnd[2];
